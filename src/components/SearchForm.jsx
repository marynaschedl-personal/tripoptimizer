...
import { Search, Loader2, ChevronDown, Plus, Minus, SlidersHorizontal } from 'lucide-react';
import clsx from 'clsx';
import { DESTINATION_CITIES, ORIGIN_CITIES } from '../data/mockData.js';

function CityDropdown({ label, value, onChange, cities, placeholder, id }) {
...
function CounterInput({ label, value, onChange, min, max }) {
  return (
